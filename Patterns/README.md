Every pattern is from the basic js pattern: Module pattern. This pattern give you the possibility to modulized your code and make your script indipendent from others script.<br />
